#############################################################################
# Makefile for building: NulleX-Qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Fri Apr 20 11:16:23 2018
# Project:  NulleX-Qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile NulleX-Qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /home/oem/Desktop/GPU-Coin/src/leveldb/libleveldb.a /home/oem/Desktop/GPU-Coin/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
$(TARGET): /home/oem/Desktop/GPU-Coin/src/leveldb/libleveldb.a /home/oem/Desktop/GPU-Coin/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: NulleX-Qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile NulleX-Qt.pro
...
/home/oem/Desktop/GPU-Coin/src/leveldb/libleveldb.a: FORCE
	cd /home/oem/Desktop/GPU-Coin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/oem/Desktop/GPU-Coin/build/build.h: FORCE
	cd /home/oem/Desktop/GPU-Coin; /bin/sh share/genbuild.sh /home/oem/Desktop/GPU-Coin/build/build.h
